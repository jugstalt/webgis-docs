...
.. note::
   **Achtung:** Wenn *UI Master Vorlagen* verwendet werden, schaut eine Karte nicht zwingend 
   gleich aus, wie im MapBuilder erstellt. Öffnet man die Karte über den Kartenviewer (und nicht über 
   den MapBuilder) werden zusätzlich die *UI Elemente* aus den Vorlagen geladen.
