...
Button im **Karten Viewer** in die Karte einbinden (sofern dieser Button in der Karte anboten wird).
...
Natürlich ist es dadurch auch möglich, dass beispielsweise ein Dienst für alle Anwender sichtbar und abfragbar ist, das Editieren von Themen
