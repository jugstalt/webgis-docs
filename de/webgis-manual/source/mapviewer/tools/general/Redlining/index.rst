...
Die Grundidee von Redlining ist es, die Karte Zeichenelementen (Linien, Flächen, Texte, Symbole) zu erweitern,
und Orte für einen Ausdruck zu markieren, zu verschicken oder anderwertig zur Verfügung zu stellen.
...
Ebenfalls besteht die Möglichkeit, das Redlining herunter zu laden und selbst zu speichern. Allerdings sollte auch
hier darauf hingewiesen werden, zukünftige Versionen der Software nicht hundertprozentig kompatibel mit alten
Projektdaten sein müssen und gewisse Eigenschaften verloren gehen können

Wenn sie das Tool zum ersten Mal nutzen, sollte sie eventuelle noch einmal unten stehende Punkte berücksichtigen
...
* Kelinere local begrentze Projektierungen. Dabei sollte die Zeichnungen nach dem Fertigstellung allerdings heruntergeladen und gespeichert werden, um keine Datenverlust zu erleiden.

* Kelinere local begrentze Projektierungen auf Basis der Kartendaten und herunterladen der gezeichnet Geo-Objekte im Esri Shape Format zum weiterverarbeiten in unterschiedlichen Softwarepaketen.
...
Möchten sie eine hier angeführtes Projekt mit dem Kartenviewer umsetzen, wenden sie sich bitte an den 
...
Geodatenbank gespeichert, was folgende Vorteil bringt:
...
* Pflege von Sachdaten: Neben Geometrie können auch beliebige Sachdaten mit der Geometrie verknüpft werden (Widmungsart, Baujahr, Material, ...)
